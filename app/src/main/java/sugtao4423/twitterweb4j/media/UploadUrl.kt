...
internal object UploadUrl {
    ...
    private fun baseUri(isVideo: Boolean) = (if (isVideo) baseUrl2 else baseUrl).toUri()
    ...
    ): String = baseUri(isVideo).buildUpon().apply {
    ...
    fun status(isVideo: Boolean, mediaId: Long): String = baseUri(isVideo).buildUpon().apply {
